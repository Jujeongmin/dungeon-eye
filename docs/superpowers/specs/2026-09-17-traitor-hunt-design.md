...
- 제단: 촛대를 올린 탁자, 지키는 범위(6m)를 둘러싼 촛대 10개. 투표 발판: 위에서 떨어지는 바닥 철창. 출구: 바닥 해치와 초록 불빛.
- 배신자·묶임 표시: 머리 위 글자("배신자"/"묶임").
- 맵 꾸미기(`dressLevel`): 벽 무늬 5종·바닥 2종 섞기, 벽 횃불, 복도 아치, 넓은 방의 매달린 우리·사슬, 벽가 사슬 더미. 칸 위치로 정해져 모두 같은 모습을 본다.
